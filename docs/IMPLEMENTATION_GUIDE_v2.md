...
- âœ… Geospatial queries (30 miles / 48km radius)
...
export default function Map() {
  ...
  useEffect(() => {
    ...
    async function fetchPrayers() {
      // NOTE: Database stores radius in km, but UI displays miles
      // Convert 30 miles to km: 30 * 1.60934 = 48.28 ≈ 48 km
      const radiusKm = 48; // 30 miles
