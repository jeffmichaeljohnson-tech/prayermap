      ...
      >
        ...
        <div className="relative glass-strong rounded-3xl p-8 shadow-2xl border border-white/30">
          ...
          >
            ...
            <h1 className="text-3xl text-gray-800 mb-2 font-['Cinzel']">
              PrayerMap
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              type="submit"
              className="relative w-full py-4 mt-6 rounded-xl overflow-hidden group"
            ...
            <motion.button
              type="button"
              onClick={() => {
                // Mock Apple sign in - in real app, this would use Apple Auth
                onAuthenticated({
                  name: 'Apple User',
                  email: 'user@privaterelay.appleid.com'
                });
              }}
              className="relative w-full py-4 rounded-xl overflow-hidden group bg-black hover:bg-gray-900 transition-colors duration-300"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
