...
import { messagingPerformanceMonitor, type MessagingPerformanceMetrics } from '../services/messaging/MessagingPerformanceMonitor';
  ...
  useEffect(() => {
    ...
    const updateMetrics = () => {
      try {
        ...
        // Get realtime health
        const rtHealth = realtimeMonitor.getHealthMetrics();
