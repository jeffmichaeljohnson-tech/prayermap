-- ============================================================================
-- PrayerMap Content Moderation - Database Schema Migration (FIXED)
-- ============================================================================
...
-- Drop existing table (policies will be dropped automatically with CASCADE)
...
-- Create policies for user_bans AFTER table is fully created
...
-- Drop existing table (policies will be dropped automatically with CASCADE)
DROP TABLE IF EXISTS public.prayer_flags CASCADE;
...
-- Create policies AFTER table is fully created and committed
...
BEGIN
  ...
  -- Log the action (only if log_admin_action exists)
  BEGIN
