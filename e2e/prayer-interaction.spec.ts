...
test.describe('Prayer Interaction', () => {
  ...
  test.describe('Viewing Prayers', () => {
    test('should display prayers on map', async ({ authenticatedPage, geolocatedPage }) => {
    ...
    test('should cluster nearby prayers', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
      ...
      const hasClusters = await clusterMarker.isVisible().catch(() => false);

      // Clustering may or may not be present depending on prayer density
      expect(true).toBeTruthy();
    });

    test('should show prayer details on click', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
    ...
    test('should play audio prayers', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
    ...
    test('should play video prayers', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
  ...
  test.describe('Responding to Prayers', () => {
    test('should show response options', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
    ...
    test('should send text response', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
    ...
    test('should send audio response', async ({ authenticatedPage, geolocatedPage, context }) => {
      ...
      if (await marker.isVisible().catch(() => false)) {
        ...
        const hasAudioResponse = await audioButton.isVisible().catch(() => false);
    ...
    test('should send video response', async ({ authenticatedPage, geolocatedPage, context }) => {
      ...
      if (await marker.isVisible().catch(() => false)) {
        ...
        const hasVideoResponse = await videoButton.isVisible().catch(() => false);
    ...
    test('should create prayer connection', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
      ...
      if (await marker.isVisible().catch(() => false)) {
        ...
        if (await respondButton.isVisible().catch(() => false)) {
          ...
          const hasConnection = await connectionLine.isVisible().catch(() => false);
    ...
    test('should show spotlight animation', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
      ...
      if (await marker.isVisible().catch(() => false)) {
        ...
        const hasSpotlight = await spotlight.isVisible().catch(() => false);
  ...
  test.describe('Quick Pray', () => {
    test('should send quick prayer response', async ({ authenticatedPage, geolocatedPage }) => {
      await authenticatedPage.goto('/');
      await authenticatedPage.waitForTimeout(5000);
